...
typedef enum {
    ...
    OSD_DROP_PREDICTION,        // Predicted crash landing offset + safety radius
    OSD_DROP_PREDICTION_COMBO,  // Altitude/h-speed/v-speed/heading at the failure moment
    OSD_DROP_PREDICTION_GPS,    // Lat/lon at the failure moment
#endif
