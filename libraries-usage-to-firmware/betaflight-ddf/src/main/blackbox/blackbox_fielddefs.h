...
typedef struct flightLogEvent_droneDropPrediction_s {
    float meanXMeters;
    float meanYMeters;
    float meanDistanceMeters;
    float p95DistanceMeters;
} flightLogEvent_droneDropPrediction_t;
...
typedef union flightLogEventData_u {
    ...
    flightLogEvent_droneDropPrediction_t droneDropPrediction;
