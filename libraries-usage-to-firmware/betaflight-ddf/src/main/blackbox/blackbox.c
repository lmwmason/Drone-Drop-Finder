...
void blackboxLogEvent(FlightLogEvent event, flightLogEventData_t *data)
{
    ...
    case FLIGHT_LOG_EVENT_LOGGING_RESUME:
        ...
        break;
    case FLIGHT_LOG_EVENT_DRONE_DROP_PREDICTION:
        blackboxWriteFloat(data->droneDropPrediction.meanXMeters);
        blackboxWriteFloat(data->droneDropPrediction.meanYMeters);
        blackboxWriteFloat(data->droneDropPrediction.meanDistanceMeters);
        blackboxWriteFloat(data->droneDropPrediction.p95DistanceMeters);
        break;
