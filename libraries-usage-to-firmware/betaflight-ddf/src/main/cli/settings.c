...
// DRONE DROP FINDER
    ...
    { "drone_drop_finder", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_DRONE_DROP_FINDER_CONFIG, offsetof(droneDropFinderConfig_t, enabled) },
    { "drone_drop_trigger_rx_loss", VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_DRONE_DROP_FINDER_CONFIG, offsetof(droneDropFinderConfig_t, triggerOnRxLoss) },
    { "drone_drop_update_interval_ms", VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 200, 10000 }, PG_DRONE_DROP_FINDER_CONFIG, offsetof(droneDropFinderConfig_t, updateIntervalMs) },
#endif
