...
// Drone Drop Finder needs GPS (altitude/velocity at the failure moment)
// and an SD card (to load sweep.csv into the LUT at boot).
#if defined(USE_GPS) && defined(USE_SDCARD) && !defined(USE_DRONE_DROP_FINDER)
#define USE_DRONE_DROP_FINDER
#endif
